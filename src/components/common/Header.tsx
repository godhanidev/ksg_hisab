      ...
      <div className="flex h-14 sm:h-16 w-full items-center justify-between px-2.5 sm:px-6 gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
          <button
            ...
            className="rounded-xl p-2 text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition lg:hidden shrink-0"
          ...
          <div className="flex items-center gap-2 lg:hidden min-w-0">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-transparent shadow-2xs border border-amber-500/40 ring-1 ring-amber-500/20 overflow-hidden shrink-0">
              <img
                src="/logo.png"
                alt="KS Logo"
            ...
            <div className="min-w-0">
              <h1 className="text-xs font-black text-slate-900 leading-none truncate">KS GODHANI</h1>
              <p className="text-[9px] text-amber-600 font-bold uppercase tracking-wider mt-0.5 truncate">{activePage}</p>
            </div>
          </div>
          ...
          <div className="hidden lg:block min-w-0">
            ...
            <h2 className="text-base font-bold text-slate-900 truncate">{activePage}</h2>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          <button
            onClick={onLogout}
            title={t.logout}
            className="flex items-center gap-1.5 rounded-xl border border-slate-200 p-2 sm:px-3 sm:py-2 text-xs font-semibold text-slate-600 hover:bg-red-50 hover:border-red-200 hover:text-red-600 transition shrink-0"
          >
            <LogOut size={16} />
